package com.mx.ProyectoDulce.controller;
...
import com.mx.ProyectoDulce.servicios.DulceServ;

@RestController
@RequestMapping("DulceWs") //solicitud HTTP
@CrossOrigin
public class DulceWs {
	...
	public Dulce buscar(@RequestBody Dulce dulce) {
		System.out.println("Pieza de ropa a guardar: " + dulce);
